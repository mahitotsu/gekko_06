...
rm -f "$PID_FILE"
LOG=/home/akring/gekko_0/run/pattern-a-timeline.log
: > "$LOG"
...
npx tsx pattern-a.ts > /home/akring/gekko_0/run/pattern-a-stdout.log 2>&1
NODE_EXIT=$?
...
echo "done. see $LOG and pattern-a-stdout.log"
