...
rm -f "$PID_FILE"
LOG=/home/akring/gekko_0/run/pattern-b-timeline.log
: > "$LOG"
...
npx tsx pattern-b.ts > /home/akring/gekko_0/run/pattern-b-stdout.log 2>&1
NODE_EXIT=$?
...
echo "done. see $LOG and pattern-b-stdout.log"
